...
<div class="col-lg-12 offset-lg-2x " style="margin-top:-65px;">
    ...
    <div class="table caption-top table-responsive table-responsive-sm table-responsive-md table-responsive-xl  ">
        ...
        <DataTable style="text-transform:uppercase ;" ref="myDataTable" class="table  cell-border  table-sm  display tablex table-striped table-hover table table-bordered " :columns="columns" :data="issuedItems" :options="{dom:'Bfrtip',responsive:'true',select: true,
...
export default {
    ...
    methods: {
        ...
        getDepartmentItems() {
          ...
          this.$emitter.emit('mychangeLoaderStatus', true)
            axios.get("https://centralstore.chukahighschool.sc.ke/api/issuedItem", {
                params: {
